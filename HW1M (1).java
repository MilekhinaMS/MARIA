...
public class HW1M {
    ...
    public static void main(String[] args) {
        ...
        if (storeType.equals("1")){
             ...
             Auditor furstAuditor= new Auditor();
             furstAuditor.closeStore(firstStore);
             furstAuditor.rebrand(firstStore);
            ...
            System.out.println("What directors name? ");
             ...
             Auditor furstAuditor= new Auditor();
             furstAuditor.closeStore(firstFoodshop);
             furstAuditor.rebrand(firstFoodshop);
            ...
            System.out.println("What name of the main seller? ");
             ...
             Auditor furstAuditor= new Auditor();
             furstAuditor.closeStore(firstClothingStore);
             furstAuditor.rebrand(firstClothingStore);
